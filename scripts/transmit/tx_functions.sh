...
detect_audio()
{
  ...
  # Then, depending on the values of  $AUDIO_PREF and $VIDEOSOURCE it sets
  ...
  *)
    PIC_INPUT="DIGITAL"
    printf "Mode Input is $VIDEOSOURCE \n"
  ;;
  esac
  printf "Video Input is $PIC_INPUT \n"
...
detect_video()
{
  ...
  # Returns VID_WEBCAM in the form /dev/video0
  ...
  ## Returns WEBCAM_TYPE as one of the following list                                ##
