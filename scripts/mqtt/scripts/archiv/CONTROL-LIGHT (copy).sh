...
if [[ "$MODE" == "qpsk" ]]; then
echo "Which parameter to change, PTT off (0), PTT on (1), Frequency (2), Gain (3), Digital Gain (4), Mode SR and FEC (5) :"
read CONTROL
fi

if ! [[ "$MODE" == "qpsk" ]]; then
echo "Which parameter to change, PTT off (0), PTT on (1), Frequency (2), Gain (3), Mode SR and FEC (4) :"
read CONTROL
fi
