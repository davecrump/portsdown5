...
printf("\nPost setup Stream Status.fifoSize = %d, Status.fifoFilledCount = %d\n", Status.fifoSize, Status.fifoFilledCount);
...
printf("\nPresendstream  Stream Status.fifoSize = %d, Status.fifoFilledCount = %d\n", Status.fifoSize, Status.fifoFilledCount);

        sendStream = LMS_SendStream(&tx_stream, sdrSamples, nSamples, NULL, 1000);
LMS_GetStreamStatus(&tx_stream, &Status);
printf("\nPost-sendstream  Stream Status.fifoSize = %d, Status.fifoFilledCount = %d\n", Status.fifoSize, Status.fifoFilledCount);
